...
if [ -f "${WORKER_LOCAL}" ]; then
  ...
  WORKER_URL="${EASYLAB_ARTIFACT_URL:-http://easylab.temp.svc.cluster.local}/artifacts/generic/${WORKER_NAME:-easyworker}/${WORKER_VERSION:-v0.5.2}/easyworker-linux-amd64"
